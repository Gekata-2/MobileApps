...
Java_com_example_a08_1logic_1integration_MainActivity_getCounter(JNIEnv *env, jclass clazz,
                                                                 jlong nativePointer) {
...
extern "C"
JNIEXPORT jlong JNICALL
Java_com_example_a08_1logic_1integration_MainActivity_increaseCounter(JNIEnv *env, jclass clazz,
                                                                      jlong nativePointer) {
...
extern "C"
JNIEXPORT jlong JNICALL
Java_com_example_a08_1logic_1integration_MainActivity_resetCounter(JNIEnv *env, jclass clazz,
                                                                   jlong nativePointer) {
    Counter *pointer = ((Counter *) nativePointer);
